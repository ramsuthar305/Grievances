...
if($_POST['submit']=='update'){
        ...
        $e_description=($_POST['event_description']);
        $e_duration=($_POST['event_duration']);
       
        $query_main="update events SET event_name='$e_name',event_date='$e_date',event_time='$e_time',event_description='$e_description',event_duration='$e_duration' where event_id='$e_id1'";
...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <?php
                                        $fetch_events=mysqli_query($conn,"select event_id,event_name,event_type,event_time,event_date,event_duration,event_description from events where event_id=$e_id ")or die(mysqli_error());
                                        while($result_product=mysqli_fetch_array($fetch_events)){
                                            $event_id=$result_product['event_id'];
                                            $event_name=$result_product['event_name'];
                                            $event_time=$result_product['event_time'];
                                            $event_date=$result_product['event_date'];
                                            $event_duration=$result_product['event_duration'];
                                            $event_description=$result_product['event_description'];
                                            ?>
        <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"> <img src="../assets/images/users/5.jpg" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php echo $event_name; ?></h4>
                                    ...
                                    <div class="row text-center justify-content-md-center">
                                        ...
                                        <div class="col-4"><a href="javascript:void(0)" class="link"><i class="icon-people"></i> <font class="font-medium" color="red">54<br>
                                            <sub>Empty Seats</sub></font></a></div>
                                    </div>
                                </center>
                            </div>
                            <div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="card-block">
                                        <div class="profiletimeline">
                                            <div class="sl-item">
                                                ...
                                                <div class="sl-right">
                                                    <div><a href="eventsview.php?eid=$event_id" class="link"><?php echo $event_name; ?></a> <span class="sl-date"><?php echo $event_date; ?></span>
                                ...
                                <div class="tab-pane" id="settings" role="tabpanel">
                                    <div class="card-block">
                                        ...
                                        <form class="form-horizontal form-material" action="eventsview.php?eid1=<?php echo $event_id;?>" method="POST">
                                            <div class="form-group">
                                                <label class="col-md-12">Event Name</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="event_name" value="<?php echo $event_name;?>" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-email" class="col-md-12">Event date</label>
                                                <div class="col-md-12">
                                                    <input type="date" value="<?php echo $event_date;?>" class="form-control form-control-line" name="event_date" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Event Time</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="event_time" value="<?php echo $event_time;?>" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Event duration</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="event_duration" value="<?php echo $event_duration;?>" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Event Description</label>
                                                <div class="col-md-12">
                                                    <input type="text" rows="5" name="event_description" value="<?php echo $event_description;?>" class="form-control form-control-line"></textarea>
                                                </div>
                                            </div>
                                            <?php } ?>
                                            <div class="form-group">
